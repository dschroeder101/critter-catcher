...
class Critter extends Entity {
    ...
    isCurrentlyAvailable(currentMonth, currentHour, hemisphere) {
        ...
        if (hemisphere === NORTHERN_HEMISPHERE) {
            availableThisMonth = this.northernHemisphere.months[currentMonth].available;
        } else if (hemisphere === SOUTHERN_HEMISPHERE) {
            availableThisMonth = this.southernHemisphere.monts[currentMonth].available;
        } else {
            return false;
        }
        ...
        if (availableThisMonth) {
            if (this.schedule.allDay) {
                ...
                return currentHour >= this.schedule.startingTime 
